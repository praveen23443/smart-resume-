...
# ── New modules: Auth, Interview, Coding ──────────────────────────────────────
from auth.auth import render_auth_page, is_logged_in, logout_user, init_auth_tables
from interview.interview_ui import render_interview_assistant
from coding_practice.coding_ui import render_coding_practice
# ─────────────────────────────────────────────────────────────────────────────
...
import datetime
def disable_toast(*args, **kwargs):
    pass

st.toast = disable_toast
...
# ── Remove top black bar globally ──────────────────────────────────────────
st.markdown("""
<style>
[data-testid="stHeader"]     { display:none !important; height:0 !important; }
[data-testid="stDecoration"] { display:none !important; height:0 !important; }
[data-testid="stToolbar"]    { display:none !important; height:0 !important; }
[data-testid="stTop"]        { display:none !important; height:0 !important; }
...
class ResumeApp:
    def __init__(self):
        ...
        self.pages = {
            ...
            "🎤 INTERVIEW ASSISTANT": self.render_interview_assistant,
            "💻 CODING PRACTICE": self.render_coding_practice,
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://hareeshbhumireddi.github.io/Harish-portfolio-Main/' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://linkedin.com/in/tejaswini-kuppili-818793353" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Tejaswini Kuppili</b>
                </a>
            </p>
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/Hunterdii'}"
                     alt="Tejaswini Kuppili"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/Hunterdii';">
                <h2 class="profile-name">Tejaswini Kuppili</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/hareeshbhumireddi" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/tejaswini-kuppili-818793353" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:kuppilitejaswini3@gmail.com" class="social-link" target="_blank">
    ...
    def render_home(self):
        ...
        st.toast("Check out these repositories: [AI-Nexus(AI/ML)](https://github.com/hareeshbhumireddi)", icon="ℹ️")
    ...
    def render_interview_assistant(self):
        """Render the Interview Assistant page"""
        render_interview_assistant()

    def render_coding_practice(self):
        """Render the Coding Practice page"""
        render_coding_practice()
    ...
    def main(self):
        ...
        with st.sidebar:
            ...
            for page_name in self.pages.keys():
                if st.button(page_name, use_container_width=True):
                    cleaned_name = page_name.lower().replace(" ", "_").replace("🏠", "").replace("🔍", "").replace("📝", "").replace("📊", "").replace("🎯", "").replace("💬", "").replace("ℹ️", "").replace("🎤", "").replace("💻", "").strip()
                    st.session_state.page = cleaned_name
                    st.rerun()
        ...
        page_mapping = {name.lower().replace(" ", "_").replace("🏠", "").replace("🔍", "").replace("📝", "").replace("📊", "").replace("🎯", "").replace("💬", "").replace("ℹ️", "").replace("🎤", "").replace("💻", "").strip(): name 
